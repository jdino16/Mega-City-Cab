                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            ...
                            <td><%= status %></td>
                            <td>
                                <a href="editPayment.jsp?transactionId=<%= transactionId %>" class="action-link">
                                    <i class="fas fa-edit"></i> Edit
                                </a> |
                                <a href="deletePaymentServlet?transactionId=<%= transactionId %>" class="action-link" onclick="return confirm('Are you sure you want to delete this payment?')">
